...
gint xmms_connect_to_session(
    gint session); /* Do NOT use this! This is only for control socket initialization now. */
...
#define xmms_remote_add_files(session, list) xmms_remote_playlist_add(session, list)
