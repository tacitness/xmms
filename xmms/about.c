...
static const char *credit_text[] =
    {/* ---------------------------------------------------------------
     ...
     N_("Anders Carlsson (effect plugins)"), N_("Chun-Chung Chen (xfont patch)"),
     N_("Tim Ferguson (joystick plugin)"), N_("Ben Gertzfield"), N_("Vesa Halttunen"),
     N_("Logan Hanks"), N_("Eric L. Hernes (FreeBSD patches)"), N_("Ville Herva"),
     N_("Ian 'Hixie' Hickson"), N_("highway (MMX)"), N_("Michael Hipp and others (MPG123 engine)"),
     ...
     N_("Matti Hamalainen"), N_("David Jacoby"), N_("Osamu Kayasono (3DNow!/MMX)"),
     N_("Lyle B Kempler"), N_("J. Nick Koston (MikMod plugin)"), N_("Aaron Lehmann"),
     N_("Johan Levin (echo + stereo plugin)"), N_("Eric Lindvall"), N_("Colin Marquardt"),
     N_("Willem Monsuwe"), N_("Heikki Orsila"), N_("Gian-Carlo Pascutto"),
     N_("John Riddoch (Solaris plugin)"), N_("Josip Rodin"), N_("Pablo Saratxaga (i18n)"),
     N_("Carl van Schaik (pro logic plugin)"),
     /* I18N: UTF-8 translation: "J\303\266rg Schuler" */
     N_("Joerg Schuler"), N_("Charles Sielski (irman plugin)"), N_("Espen Skoglund"),
     N_("Matthieu Sozeau (ALSA plugin)"), N_("Kimura Takuhiro (3DNow!)"), N_("Zinx Verituse"),
     N_("Ryan Weaver (RPMs among other things)"), N_("Chris Wilson"), N_("Dave Yearke"),
     N_("Stephan K. Zitz"), NULL, N_("Default skin:"), N_("Leonard \"Blayde\" Tan"),
     N_("Robin Sylvestre (Equalizer and Playlist)"), N_("Thomas Nilsson (New titles and cleanups)"),
     NULL, N_("Homepage and Graphics:"), N_("Thomas Nilsson"), NULL, N_("Support and Docs:"),
     /* I18N: UTF-8 translation: "Olle H\303\244lln\303\244s" */
     N_("Olle Hallnas"), NULL, NULL};

static const char *translators[] =
    {N_("Afrikaans:"),
     /* I18N: UTF-8 translation: "Schalk W. Cronj\303\251" */
     N_("Schalk W. Cronje"), NULL, N_("Albanian:"), N_("Naim Daka"), NULL, N_("Azerbaijani:"),
     /* I18N: UTF-8 translation: "M\311\231tin \306\217mirov" */
     N_("Metin Amiroff"),
     /* I18N: UTF-8 translation: "Vasif \304\260smay\304\261lo\304\237lu" */
     N_("Vasif Ismailoglu"), NULL, N_("Basque:"),
     /* I18N: UTF-8 translation: "I\303\261igo Salvador Azurmendi" */
     N_("Inigo Salvador Azurmendi"), NULL, N_("Belarusian:"), N_("Smaliakou Zmicer"), NULL,
     N_("Bosnian:"),
     /* I18N: UTF-8 translation: "Amila Akagi\304\207" */
     N_("Amila Akagic"), N_("Grabovica Eldin"), N_("Vedran Ljubovic"), NULL,
     N_("Brazilian Portuguese:"), N_("Juan Carlos Castro y Castro"), NULL, N_("Bulgarian:"),
     N_("Boyan Ivanov"), N_("Yovko D. Lambrev"), NULL, N_("Catalan:"), N_("Albert Astals Cid"),
     N_("Quico Llach"), N_("Jordi Mallach"), NULL, N_("Chinese:"), N_("Chun-Chung Chen"),
     N_("Jouston Huang"), N_("Andrew Lee"), N_("Chih-Wei Huang"), N_("Shiyu Tang"),
     N_("Danny Zeng"), NULL, N_("Croatian:"), N_("Vlatko Kosturjak"), N_("Vladimir Vuksan"), NULL,
     N_("Czech:"),
     /* I18N: UTF-8 translation: "Vladim\303\255r Marek" */
     N_("Vladimir Marek"), N_("Radek Vybiral"), NULL, N_("Danish:"), N_("Nikolaj Berg Amondsen"),
     N_("Troels Liebe Bentsen"), N_("Kenneth Christiansen"), N_("Keld Simonsen"), NULL,
     N_("Dutch:"), N_("Jorn Baayen"), N_("Bart Coppens"), N_("Wilmer van der Gaast"),
     N_("Tom Laermans"), NULL, N_("Esperanto:"), N_("D. Dale Gulledge"), NULL, N_("Estonian:"),
     N_("Marek Laane"), NULL, N_("Finnish:"), N_("Thomas Backlund"), N_("Matias Griese"), NULL,
     N_("French:"), N_("Arnaud Boissinot"), N_("Eric Fernandez-Bellot"), NULL, N_("Galician:"),
     /* I18N: UTF-8 translation: "Alberto Garc\303\255a" */
     N_("Alberto Garcia"),
     /* I18N: UTF-8 translation: "David Fern\303\241ndez Vaamonde" */
     N_("David Fernandez Vaamonde"), NULL, N_("Georgian:"), N_("Aiet Kolkhi"), NULL, N_("German:"),
     N_("Colin Marquardt"), N_("Stefan Siegel"), NULL, N_("Greek:"), N_("Kyritsis Athanasios"),
     NULL, N_("Hungarian:"), N_("Arpad Biro"), NULL, N_("Indonesian:"), N_("Budi Rachmanto"), NULL,
     N_("Irish:"), N_("Alastair McKinstry"), NULL, N_("Italian:"), N_("Paolo Lorenzin"),
     N_("Daniele Pighin"), NULL, N_("Japanese:"), N_("Hiroshi Takekawa"), NULL, N_("Korean:"),
     N_("Jaegeum Choe"), N_("Sang-Jin Hwang"), N_("Byeong-Chan Kim"), N_("Man-Yong Lee"), NULL,
     N_("Lithuanian:"), N_("Gediminas Paulauskas"), NULL, N_("Latvian:"),
     /* I18N: UTF-8 translation: "Juris Kudi\305\206\305\241" */
     N_("Juris Kudins"), N_("Vitauts Stochka"), NULL, N_("Malay:"),
     N_("Muhammad Najmi Ahmad Zabidi"), NULL, N_("Norwegian:"),
     /* I18N: UTF-8 translation: "Andreas Bergstr\303\270m" */
     N_("Andreas Bergstrom"), N_("Terje Bjerkelia"), N_("Haavard Kvaalen"), N_("Roy-Magne Mo"),
     N_("Espen Skoglund"), NULL, N_("Polish:"), N_("Grzegorz Kowal"), NULL, N_("Portuguese:"),
     N_("Jorge Costa"), NULL, N_("Romanian:"), N_("Florin Grad"),
     /* I18N: UTF-8 translation: "Mi\305\237u Moldovan" */
     N_("Misu Moldovan"), NULL, N_("Russian:"), N_("Valek Filippov"), N_("Alexandr P. Kovalenko"),
     N_("Maxim Koshelev"), N_("Aleksey Smirnov"), NULL, N_("Serbian:"), N_("Tomislav Jankovic"),
     NULL, N_("Slovak:"), N_("Pavol Cvengros"), NULL, N_("Slovenian:"), N_("Tadej Panjtar"),
     N_("Tomas Hornocek"), N_("Jan Matis"), NULL, N_("Spanish:"), N_("Fabian Mandelbaum"),
     N_("Jordi Mallach"),
     /* I18N: UTF-8 translation: "Juan Manuel Garc\303\255a Molina" */
     N_("Juan Manuel Garcia Molina"), NULL, N_("Swedish:"), N_("David Hedbor"), N_("Olle Hallnas"),
     N_("Thomas Nilsson"), N_("Christian Rose"), N_("Fuad Sabanovic"), NULL, N_("Tajik:"),
     N_("Roger Kovacs"), N_("Dilshod Marupov"), NULL, N_("Thai:"), N_("Pramote Khuwijitjaru"),
     N_("Supphachoke Suntiwichaya"), NULL, N_("Turkish:"), N_("Nazmi Savga"),
     /* I18N: UTF-8 translation: "\303\226mer Fad\304\261l Usta" */
     N_("Omer Fadil Usta"), NULL, N_("Ukrainian:"), N_("Dmytro Koval'ov"), NULL, N_("Uzbek:"),
     N_("Mashrab Kuvatov"), NULL, N_("Vietnamese:"), N_("Trinh Minh Thanh"), NULL, N_("Walloon:"),
     N_("Lucyin Mahin"), N_("Pablo Saratxaga"), NULL, N_("Welsh:"), N_("Rhoslyn Prys"), NULL, NULL};
...
void show_about_window(void)
{
    ...
    gtk_notebook_append_page(GTK_NOTEBOOK(about_notebook), list, gtk_label_new(_("Credits")));
