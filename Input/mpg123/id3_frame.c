...
static struct id3_framedesc framedesc[] = {
    ...
    {ID3_USLT, "USLT", "Unsynchronized lyric/text transcription"},
...
static struct id3_framedesc22 framedesc22[] = {
    ...
    {ID3_ULT, ID3_USLT}, /* Unsynchronized lyric/text transcription */
...
static struct id3_framedesc *find_frame_description(guint32 id)
{
    int i;
...
static int decompress_frame(struct id3_frame *frame)
{
     ...
     */
    frame->fr_data_z = g_malloc(frame->fr_size_z + (id3_frame_is_text(frame) ? 2 : 0));
...
static guint32 find_v24_id(guint32 v22)
{
    int i;
