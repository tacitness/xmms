...
static GtkWidget *decode_freq_frame, *decode_freq_vbox, *decode_freq_1to1, *decode_freq_1to2,
    *decode_freq_1to4;
static GtkWidget *option_frame, *option_vbox, *detect_by_content, *detect_by_extension,
    *detect_by_both;
#ifdef USE_SIMD
...
static void mpg123_configurewin_ok(GtkWidget *widget, gpointer data)
{
    ...
    mpg123_cfg.cast_title_streaming =
        gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(streaming_cast_title));
...
void mpg123_configure(void)
{
...
#ifdef USE_SIMD
    {
        ...
        decoder_mmx = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(decoder_3dnow),
                                                                  _("MMX optimized decoder"));
        gtk_box_pack_start(GTK_BOX(decoder_vbox), decoder_mmx, FALSE, FALSE, 0);

        decoder_fpu = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(decoder_3dnow),
                                                                  _("FPU decoder"));
    ...
    streaming_cast_title =
        gtk_check_button_new_with_label(_("Enable SHOUT/Icecast title streaming"));
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(streaming_cast_title),
                                 mpg123_cfg.cast_title_streaming);
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(title_id3v2_disable), mpg123_cfg.disable_id3v2);
