...
/*
   ...
   Changes: (1) 2/1/99 Initial Build / Release
   (2) 2/2/99 Psychotron fixed a small problem w/interfacing
   (3) 2/2/99 Shows Channels in spectrum analyzer
   (4) 2/2/99 Fixed the infinite loop problem, and the absured channel
...
static GtkWidget *Sample_44, *Sample_22, *Sample_11, *Curious_Check, *Surrond_Check, *Fadeout_Check,
    *Interp_Check;
...
static void configure()
{
    ...
    if (!mikmod_conf_window) {
        ...
        gtk_object_set_data(GTK_OBJECT(mikmod_conf_window), "mikmod_conf_window",
                            mikmod_conf_window);
        ...
        gtk_signal_connect(GTK_OBJECT(mikmod_conf_window), "destroy",
                           GTK_SIGNAL_FUNC(gtk_widget_destroyed), &mikmod_conf_window);
        ...
        Fadeout_Check =
            gtk_check_button_new_with_label(_("Force volume fade at the end of the module"));
...
InputPlugin mikmod_ip = {NULL,      NULL,     NULL, /* Description */
                         init,      aboutbox, configure, is_our_file,   NULL,
                         play_file, stop,     mod_pause, seek,          NULL,
                         get_time,  NULL,     NULL,      NULL,          NULL,
                         NULL,      NULL,     NULL,      get_song_info, NULL, /* file_info_box */
                         NULL};
